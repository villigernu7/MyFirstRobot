...
public class Robot extends IterativeRobot {
	...
	public void robotInit() {
		drivetrain = new Drivetrain(new CANTalon(RobotMap.CAN.DRIVE_LEFT_1), new CANTalon(RobotMap.CAN.DRIVE_LEFT_2),
		...
		feeder = new Feeder(new VictorSP(RobotMap.PWM.BLENDER), new VictorSP(RobotMap.PWM.FEEDER));
		gear = new Gear(new VictorSP(RobotMap.PWM.GEAR_DROPPER), new DigitalInput(RobotMap.DIO.GEAR_DROPPER_OPEN),
